...
public class EmailServiceImp implements EmailService{
	...
	private static final String MY_EMAIL = "tfgRecoverPwd2026@gmail.com";
	
	private static final String SUBJECT_EMAIL = "Recuperación contraseña - TFG";
	...
	EmailServiceImp(TokenTemporalyRepository tokenRepo, UserService userService, JavaMailSender emailSender){
	    ...
	    try {
	        ...
	        String htmlContent = "<!DOCTYPE html>"
	                ...
	                + "<h1 style='margin:0; color:#ffffff; font-size:28px;'>TFG</h1></td></tr>"
	                ...
	                + "<p style='margin:0; font-size:13px; color:#ffffff;'>© 2026 TFG</p></td></tr>"
